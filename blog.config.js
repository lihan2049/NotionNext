...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || 'Liberté, Égalité, Fraternité', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://1228.fun', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '1228, blog', // 网站关键词 英文逗号隔开
